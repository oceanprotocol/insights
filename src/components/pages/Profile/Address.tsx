  ...
  return (
    <div
      className={cs(
        ...
        "d-flex flex-column flex-md-row justify-content-center align-items-center mb-2 mb-md-5"
      )}
    >
      ...
      <div className="d-flex flex-column align-items-center align-items-md-start mt-4 mt-md-0 ms-0 ms-md-3 text-white">
        ...
        <div
          className={cs(
            style.linkBox,
            "d-flex flex-row justify-content-center justify-content-md-between flex-wrap"
          )}
        >
